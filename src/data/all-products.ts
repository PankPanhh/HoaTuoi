...
    ],
    category: 'Tulip',
    color: 'Hồng', // Chỉ định màu chủ đạo
    type: 'Hoa bó',
    occasion: 'Valentine',
  },
  {
...
    price: 390000,
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80', // Thay bằng ảnh Lily trắng nếu có
    images: [
      'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80',
      'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80',
    ],
...
    price: 340000,
    image: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80', // Placeholder
    images: [
      'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80',
    ],
    category: 'Khác',
...
    price: 260000,
    image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=400&q=80', // Placeholder
    images: [
      'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=400&q=80',
    ],
    category: 'Khác',
...
  {
    id: '14',
    name: 'Chậu Hoa Lily Vàng Rực Rỡ',
    description: 'Sang trọng và rực rỡ, mang ý nghĩa may mắn, tài lộc và sự thịnh vượng cho ngày sinh nhật.',
    price: 450000,
    image: 'https://images.unsplash.com/photo-1542845688-6623e5900593?auto=format&fit=crop&w=400&q=80',
    images: [
...
  {
    id: '28',
    name: 'Chậu Hoa Sâm Báo Độc Đáo',
    description: 'Mang vẻ đẹp độc đáo, lạ mắt và tràn đầy sức sống, thích hợp làm quà tặng sinh nhật đặc biệt.',
    price: 180000,
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80', // Placeholder
    images: [
      'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80',
    ],
    category: 'Khác',
    color: 'Hồng', // Sâm báo thường có màu hồng tím hoặc xanh lá
    type: 'Hoa chậu',
    occasion: 'Sinh nhật',
  },
...
  {
    id: '18',
    name: 'Kệ Hoa Lily Hồng Khai Trương',
    description: 'Chúc mừng khai trương hồng phát, thành công rực rỡ và phát triển bền vững, mang đến vẻ đẹp thanh lịch.',
    price: 480000,
    image: 'https://images.unsplash.com/photo-1601004664883-93d39589d7b4?auto=format&fit=crop&w=400&q=80',
    images: [
      'https://images.unsplash.com/photo-1601004664883-93d39589d7b4?auto=format&fit=crop&w=400&q=80',
      'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80',
    ],
    category: 'Lily',
    color: 'Hồng',
...
  {
    id: '23',
    name: 'Bó Hoa Lily Trắng Chúc Mừng Tốt Nghiệp',
    description: 'Vẻ đẹp tinh khôi, tượng trưng cho sự trong sáng và thành quả học tập, món quà ý nghĩa chúc mừng tân cử nhân.',
    price: 400000,
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80', // Thay bằng ảnh Lily trắng nếu có
    images: [
      'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80',
...
  {
    id: '25',
    name: 'Chậu Hoa Trạng Nguyên Đỏ Giáng Sinh',
    description: 'Biểu tượng truyền thống của Giáng sinh, mang không khí ấm áp, may mắn và an lành đến mọi nhà.',
    price: 380000,
    image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=400&q=80', // Thay bằng ảnh Trạng Nguyên
    images: [
      'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=400&q=80',
      'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80',
    ],
...
  {
    id: '26',
    name: 'Bó Hoa Lily Trắng Mùa Giáng Sinh',
    description: 'Vẻ đẹp thanh khiết, mang không khí an lành, bình yên và thiêng liêng của mùa Giáng sinh.',
    price: 450000,
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80', // Thay bằng ảnh Lily trắng có decor Giáng sinh
    images: [
      'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80',
      'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80',
    ],
...
    price: 270000,
    image: 'https://images.unsplash.com/photo-1517721868356-8208a0d4c81a?auto=format&fit=crop&w=400&q=80', // Thay bằng ảnh Cúc mini có decor Giáng sinh
    images: [
      'https://images.unsplash.com/photo-1517721868356-8208a0d4c81a?auto=format&fit=crop&w=400&q=80',
      'https://images.unsplash.com/photo-1517721868356-8208a0d4c81a?auto=format&fit=crop&w=400&q=80',
    ],
...
  // --- Dịp: Hoa cưới (Bổ sung thêm) ---
  {
    id: '31',
    name: 'Bó Hoa Hồng Trắng & Baby Cưới',
    description: 'Sự kết hợp hoàn hảo của vẻ đẹp tinh khôi và tình yêu thuần khiết, lý tưởng cho ngày cưới.',
    price: 600000,
    image: 'https://images.unsplash.com/photo-1526462725907-2a4c9b1f2b6e?auto=format&fit=crop&w=400&q=80',
    images: [
      'https://images.unsplash.com/photo-1526462725907-2a4c9b1f2b6e?auto=format&fit=crop&w=400&q=80',
...
  {
    id: '33',
    name: 'Kệ Hoa Lan Hồ Điệp Cưới',
    description: 'Tượng trưng cho tình yêu bền vững, hạnh phúc viên mãn và sự sang trọng trong ngày trọng đại.',
    price: 850000,
    image: 'https://images.unsplash.com/photo-1597818788434-5f5f4f89f2d6?auto=format&fit=crop&w=400&q=80',
    images: [
      'https://images.unsplash.com/photo-1597818788434-5f5f4f89f2d6?auto=format&fit=crop&w=400&q=80',
...
  },
    ...
    {
        id: '35',
        name: 'Bó Hoa Hướng Dương & Cẩm Tú Cầu Tươi Sáng',
        description: 'Sự kết hợp của niềm vui, hy vọng và lòng biết ơn, lý tưởng cho sinh nhật hoặc các dịp chúc mừng.',
        price: 380000,
        image: 'https://images.unsplash.com/photo-1599557434199-31e34b9d5c41?auto=format&fit=crop&w=400&q=80',
        images: [
            'https://images.unsplash.com/photo-1599557434199-31e34b9d5c41?auto=format&fit=crop&w=400&q=80',
            'https://images.unsplash.com/photo-1587393433986-e4d0c1e8d1b1?auto=format&fit=crop&w=400&q=80',
        ],
    ...
    {
        id: '36',
        name: 'Kệ Hoa Lan Hồ Điệp Tím Quyến Rũ',
        description: 'Biểu tượng của sự sang trọng, bí ẩn và thành công, thích hợp cho khai trương và các sự kiện lớn.',
        price: 680000,
        image: 'https://images.unsplash.com/photo-1620202068940-a19f20c4c4e7?auto=format&fit=crop&w=400&q=80',
        images: [
            'https://images.unsplash.com/photo-1620202068940-a19f20c4c4e7?auto=format&fit=crop&w=400&q=80',
            'https://images.unsplash.com/photo-1597818788434-5f5f4f89f2d6?auto=format&fit=crop&w=400&q=80',
        ],
    ...
    {
        id: '37',
        name: 'Giỏ Hoa Cẩm Chướng Đỏ Sắc Nồng',
        description: 'Tượng trưng cho tình yêu mãnh liệt và sự ngưỡng mộ, món quà hoàn hảo cho ngày kỷ niệm.',
        price: 310000,
        image: 'https://images.unsplash.com/photo-1510467776478-f75f3a7f8b9e?auto=format&fit=crop&w=400&q=80',
        images: [
            'https://images.unsplash.com/photo-1510467776478-f75f3a7f8b9e?auto=format&fit=crop&w=400&q=80',
    ...
    {
        id: '38',
        name: 'Chậu Hoa Lily Hồng Thơ Mộng',
        description: 'Vẻ đẹp dịu dàng và thanh thoát, mang đến sự bình yên và vẻ đẹp cho không gian sống.',
        price: 430000,
        image: 'https://images.unsplash.com/photo-1601004664883-93d39589d7b4?auto=format&fit=crop&w=400&q=80',
        images: [
            'https://images.unsplash.com/photo-1601004664883-93d39589d7b4?auto=format&fit=crop&w=400&q=80',
